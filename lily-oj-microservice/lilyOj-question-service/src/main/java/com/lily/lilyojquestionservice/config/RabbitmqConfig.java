package com.lily.lilyojquestionservice.config;
...
public class RabbitmqConfig {
    ...
    DirectExchange BiWorkExchange() {
        return new DirectExchange(MqConstant.QUESTION_EXCHANGE, true, false);
    }
    ...
    public Queue BiWorkQueue() {
        ...
        return new Queue(MqConstant.QUESTION_QUEUE, true, false, false, null);
    }


    @Bean
    Binding BiWorkRouteBinding() {
        return BindingBuilder.bind(BiWorkQueue()).to(BiWorkExchange()).with(MqConstant.QUESTION_ROUTING_KEY);
    }
