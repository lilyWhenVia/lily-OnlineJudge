...
public class QuestionSubmitEsDTO implements Serializable {
     ...
     * @return
     */
    public static QuestionSubmitEsDTO objToDto(Post post) {
        if (post == null) {
            return null;
        }
        QuestionSubmitEsDTO postEsDTO = new QuestionSubmitEsDTO();
     ...
     * @return
     */
    public static Post dtoToObj(QuestionSubmitEsDTO postEsDTO) {
        if (postEsDTO == null) {
            return null;
        }
        Post post = new Post();
